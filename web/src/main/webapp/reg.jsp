    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          <div><a class="navbar-brand" href="${ctx}/static/index.html" style="font-size:32px;">尚筹网-创意产品众筹平台</a></div>
        </div>
      </div>
    </nav>
      ...
      <form class="form-signin" role="form">
        ...
        <div class="checkbox">
          ...
          <label style="float:right">
            <a href="${ctx}/login.jsp">我有账号</a>
          </label>
        </div>
        <a class="btn btn-lg btn-success btn-block" href="${ctx}/member.html" > 注册</a>
      </form>
    </div>
